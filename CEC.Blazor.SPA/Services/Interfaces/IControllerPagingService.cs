...
{
    /// <summary>
    /// Controller Service Interface for the Paging a TRecord dataset
    /// </summary>
    public interface IControllerPagingService<TRecord> where TRecord : class, IDbRecord<TRecord>, new()
    {
        /// <summary>
