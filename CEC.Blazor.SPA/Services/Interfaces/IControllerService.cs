...
{
    /// <summary>
    /// Interface definition for a Controller Service
    ...
    public interface IControllerService<TRecord, TContext>
        ...
        where TContext : DbContext
    {
        ...
        /// </summary>
        public RecordCollection RecordValues { get; }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public Task<bool> GetRecordAsync(Guid guid, bool reload = false) => Task.FromResult(false);
